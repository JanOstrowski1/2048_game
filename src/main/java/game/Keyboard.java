...
public class Keyboard {
    ...
    public static void update(){
        for (int i = 0; i <4 ; i++) {
            ...
            if(i==0) prev[KeyEvent.VK_RIGHT] = pressed[KeyEvent.VK_RIGHT];
            if(i==0) prev[KeyEvent.VK_UP] = pressed[KeyEvent.VK_UP];
            if(i==0) prev[KeyEvent.VK_DOWN] = pressed[KeyEvent.VK_DOWN];
        }
    }
